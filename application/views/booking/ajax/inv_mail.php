														...
														<table cellpadding="0" cellspacing="0" width="100%">
															<tr>
																<td align="center" valign="middle" height="45">
																	<a id="btn" href="<?php echo $this->link_esign; ?>/invoice_detail/detail/<?php echo $bkg_no; ?>" target="_blank" style="font-size: 15px;color: #333333;background-color: #ffc423;font-weight: bold;text-align: center;text-decoration: none;border-radius: 2px;background-color: #ffc423;display: inline-block;padding: 15px 20px;">REVIEW DOCUMENT</a>
					...
					<tr>
						<td align="center">
							<table cellpadding="0" cellspacing="0" width="95%">
								...
								<tr>
									<td>
										<p style="font-size: 12px;color:#666666;"><small>This message was sent to you by <?php echo $from_name; ?>. If you would rather not receive email from this sender you may contact the sender with your request.</small></p>
									</td>
								</tr>
							</table>
						</td>
