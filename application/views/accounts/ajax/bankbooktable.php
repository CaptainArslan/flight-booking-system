...
<div class="card-body p-0-0">
    <div class="table-responsive">
        <table id="bankbook_table" class="table-striped table led-table-bg m-b-0 font-weight-400">
            <thead>
                <tr>
                    <th width="10%" class="p-r-0 p-l-0 p-t-10 p-b-10 text-center text-white sortBal">Date</th>
                    <th width="08%" class="p-r-0 p-l-0 p-t-10 p-b-10 text-center text-white sortBal">Ref.</th>
                    <th width="20%" class="p-r-0 p-l-0 p-t-10 p-b-10 text-center text-white sortBal">By/To</th>
                    <th width="28%" class="p-r-0 p-l-0 p-t-10 p-b-10 text-center text-white">Note</th>
                    ...
                    <th width="11%" class="p-r-0 p-l-0 p-t-10 p-b-10 text-center text-white">Bal.</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="p-0-3 text-center text-middle">
                        ...
                        <a class="bkgEditTrans text-danger" data-trans-id="<?php echo $ledg_row['trans_id']; ?>" data-page="bankbook"><svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 7h-3a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-3" /><path d="M9 15h3l8.5 -8.5a1.5 1.5 0 0 0 -3 -3l-8.5 8.5v3" /><line x1="16" y1="5" x2="19" y2="8" /></svg></a>
                        <?php }else{ ?>
