...
<div class="card-body p-0-0">
    <div class="table-responsive">
        <table id="cardcharge_table" class="table-striped table led-table-bg m-b-0 font-weight-400">
            <thead>
                <tr>
                    <th width="09%" class="p-r-0 p-l-0 p-t-10 p-b-10 text-center text-white sortBal">Date</th>
                    <th width="09%" class="p-r-0 p-l-0 p-t-10 p-b-10 text-center text-white sortBal">Ref.</th>
                    <th width="09%" class="p-r-0 p-l-0 p-t-10 p-b-10 text-center text-white sortBal">Auth. #</th>
                    <th width="15%" class="p-r-0 p-l-0 p-t-10 p-b-10 text-center text-white sortBal">Head</th>
                    <th width="11%" class="p-r-0 p-l-0 p-t-10 p-b-10 text-center text-white sortBal">By/To</th>
                    <th width="21%" class="p-r-0 p-l-0 p-t-10 p-b-10 text-center text-white">Note</th>
                    <th width="08%" class="p-r-0 p-l-0 p-t-10 p-b-10 text-center text-white sortBal">Dr.</th>
                    <th width="08%" class="p-r-0 p-l-0 p-t-10 p-b-10 text-center text-white sortBal">Cr.</th>
                    <th width="08%" class="p-r-0 p-l-0 p-t-10 p-b-10 text-center text-white">Bal.</th>
                    <th width="02%" class="p-r-0 p-l-0 p-t-10 p-b-10 text-center text-white">-</th>
                </tr>
            </thead>
            <tbody>
                <tr class="fixed" bgcolor="#eee">
                    <th class="p-l-0 p-r-0 text-center text-middle"><?php echo date('d-M-y',strtotime($start_date)) ; ?></th>
                    <th colspan="4" class="p-l-0 p-r-0 text-center text-middle">&nbsp;</th>
                ...
                <tr>
                    ...
                    <td class="p-0-3 text-center text-middle" data-toggle="tooltip" data-placement="left" data-original-title="<?php echo $ledg_row['t_card'] ;?>"><?php custom_echo($ledg_row['t_card'],7) ; ?></td>
                    <td class="p-0-3 text-center text-middle" data-toggle="tooltip" data-placement="left" data-original-title="<?php echo $ledg_row['trans_head'] ;?>"><?php custom_echo($ledg_row['trans_head'],15) ; ?></td>
                    <td class="p-0-3 text-center text-middle" data-toggle="tooltip" data-placement="left" data-original-title="<?php echo $ledg_row['trans_by_to'] ;?>"><?php custom_echo($ledg_row['trans_by_to'],12) ; ?></td>
                    <td class="p-0-3 text-left text-middle" data-toggle="tooltip" data-placement="left" data-original-title="<?php echo preg_replace('/[\x00-\x1F\x7F-\xFF]/', '', $ledg_row['trans_description']) ;?>"><?php echo preg_replace('/[\x00-\x1F\x7F-\xFF]/', '', $ledg_row['trans_description']) ; ?> <small class="text-success font-weight-600">(<?php echo getinitials($ledg_row['trans_created_by']); ?>)</small></td>
