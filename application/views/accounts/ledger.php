                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group m-b-0 row">
                                                    ...
                                                    <div class="col-9">
                                                        <input name="start_date" class="date form-control form-control-sm" type="text" value="<?php echo date('01-M-Y'); ?>" placeholder="Enter Start Date" required onchange="ledgerFormsubmit();" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group m-b-0 row">
                                                    ...
                                                    <div class="col-9">
                                                        <input name="end_date" class="date form-control form-control-sm" type="text" value="<?php echo date('d-M-Y'); ?>" placeholder="Enter End Date" required onchange="ledgerFormsubmit();" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group m-b-0 row">
                                                    ...
                                                    <div class="col-9">
                                                        <select class="form-control form-control-sm" name="trans_head" id="trans_head" required onchange="ledgerFormsubmit();">
                                            ...
                                            <div class="col-md-2 text-center">
                                                    <button class="ledgerFormbtn btn btn-sm btn-success" type="submit">Submit</button>
                                            </div>
                                        </div>            
                                    </form>
                                </div>
                                <div class="card ledgerdetails"></div>
                            </div>
                        </div>
                    </div>
                </div>
