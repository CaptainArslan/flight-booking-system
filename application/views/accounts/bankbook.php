                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card card-body mb-4">
                                    <form id="bankBookForm" autocomplete="off">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group m-b-0 row">
                                                    <label for="example-text-input" class="p-0 col-3 col-form-label font-weight-600 text-center">From</label>
                                                    <div class="col-9">
                                                        <input name="start_date" class="date form-control form-control-sm" type="text" value="<?php echo date('01-M-Y'); ?>" placeholder="Enter Start Date" required onchange="bankBookFormsubmit();" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group m-b-0 row">
                                                    ...
                                                    <div class="col-9">
                                                        <input name="end_date" class="date form-control form-control-sm" type="text" value="<?php echo date('d-M-Y'); ?>" placeholder="Enter End Date" required onchange="bankBookFormsubmit();" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group m-b-0 row">
                                                    ...
                                                    <div class="col-9">
                                                        <select class="form-control form-control-sm" name="trans_head" id="trans_head" required onchange="bankBookFormsubmit();">
                                                            <option selected="">Choose...</option>
                                                            <optgroup label="Bank">
                                                                <?php 
                                                                    foreach ($trans_head as $key => $head) {
                                                                        if($head['trans_head_mode']  == 'bank'){
                                                                ?>
                                                            ...
                                                            <optgroup label="others">
                                                                <?php 
                                                                    foreach ($trans_head as $key => $head) {
                                                                        if($head['trans_head_mode']  == 'others' || $head['trans_head_mode']  == ''){
                                                                ?>
                                                                <option value="<?php echo $head['head'] ; ?>"><?php echo $head['head'] ; ?></option>
                                                                <?php }} ?>
                                                            </optgroup>
                                            ...
                                            <div class="col-md-2 text-center">
                                                    <button class="bankBookFormbtn btn btn-sm btn-success" type="submit">Submit</button>
                                            </div>
                                        </div>            
                                    </form>
                                </div>
                                <div class="card bankBookdetails"></div>
                            </div>
                        </div>
                    </div>
                </div>
